...
def main(image_path):
    ...
    cv2.createTrackbar("Min R =>", window_name , 0, alpha_slider_max, partial(onTrackbar, image=image, isMax=False, channelID='R'))
    cv2.createTrackbar("Max R =>", window_name , 255, alpha_slider_max, partial(onTrackbar, image=image, isMax=True, channelID='R'))
    cv2.createTrackbar("Min G =>", window_name , 0, alpha_slider_max, partial(onTrackbar, image=image, isMax=False, channelID='G'))
    cv2.createTrackbar("Max G =>", window_name , 255, alpha_slider_max, partial(onTrackbar, image=image, isMax=True, channelID='G'))
    cv2.createTrackbar("Min B =>", window_name , 0, alpha_slider_max, partial(onTrackbar, image=image, isMax=False, channelID='B'))
    cv2.createTrackbar("Max B =>", window_name , 255, alpha_slider_max, partial(onTrackbar, image=image, isMax=True, channelID='B'))
